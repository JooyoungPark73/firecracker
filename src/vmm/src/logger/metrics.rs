...
pub struct PutRequestsMetrics {
    ...
    /// Number of PUTs triggering a nexus device attach.
    pub nexus_count: SharedIncMetric,
    /// Number of failures in attaching a nexus device.
    pub nexus_fails: SharedIncMetric,
...
impl PutRequestsMetrics {
    ...
    pub const fn new() -> Self {
        Self {
            ...
            nexus_count: SharedIncMetric::new(),
            nexus_fails: SharedIncMetric::new(),
