...
def run_benchmark(vsock_socket_path="/tmp/v.sock", payload_sizes=None, 
                 iterations=10, output_csv='benchmark_results.csv'):
    """
    Run E2E latency benchmark for vsock communication.
    ...
    try:
        for payload_size in payload_sizes:
            ...
            # Create new vsock connection for each payload size
            ...
            for i in range(iterations):
                ...
                # E2E timing: send data over vsock + wait for guest acknowledgement
                ...
                # Receive data over vsock (guest is timing until we send acknowledgement)
                msg = recv_data(sock)
                if msg is None:
